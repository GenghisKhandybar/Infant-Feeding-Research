...
infant_immediate_next %>% 
  mutate(immediate_next_narrow = fct_recode(immediate_next_narrow, "No response" = "Uninvolved", "Inserts/Offers Bottle" = "Other mother behavior", "Controlling" = "Controlling-Limiting", "Controlling" = "Controlling-Encouragment")) %>% 
