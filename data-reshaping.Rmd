...
data <- read_csv("all_data.csv") %>% #Groups are added by left_join in code chunk below.
  ...
  left_join(behavior_codebook %>% select(Behavior, Narrow_group, Wide_group, Grouped_behavior), by = "Behavior") #Adding in grouped columns - considering moving this to creating-all-data.rmd.
```
