...
#   select(Behavior, next_behavior, next_group_narrow) %>%
#   group_by(Behavior)
```
...
interaction_data %>%
  select(dyad_unit, bottle_state, Behavior, next_behavior,  next_group_narrow, switch) %>%
...
dyad_set_table <- interaction_data %>%
  select(dyad_set, Behavior, next_behavior, next_group_narrow) %>%
  group_by(Behavior, dyad_set)
```

```{r}
interaction_data %>%
  select(dyad_unit, bottle_state, Behavior, next_behavior, next_group_narrow, switch, dyad_set) %>%
  filter(bottle_state == "Bottle offered",
         dyad_unit == "Baby") %>%
  ggplot(aes(fill = next_group_narrow, x=Behavior)) +
  geom_bar(position="stack",stat ="count") + 
...
with(dyad_set_table[dyad_set_table$dyad_set == "2wkB",], table(Behavior, next_group_narrow)) %>%
  kable(caption = "2 Week - Number of Behaviors for each \nInfant Cue when State is Bottle Offered")

with(dyad_set_table[dyad_set_table$dyad_set == "2moB",], table(Behavior, next_group_narrow)) %>%
  kable(caption = "2 Month - Number of Behaviors for each \nInfant Cue when State is Bottle Offered")

with(dyad_set_table[dyad_set_table$dyad_set == "4moB",], table(Behavior, next_group_narrow)) %>%
  kable(caption = "4 Month - Number of Behaviors for each \nInfant Cue when State is Bottle Offered")

with(dyad_set_table[dyad_set_table$dyad_set == "6moB",], table(Behavior, next_group_narrow)) %>%
...
with(dyad_set_table[dyad_set_table$dyad_set == "2wkB",], prop.table(table(Behavior, next_group_narrow),1)) %>%
  kable(caption = "2 Week - Proportion of Behaviors for each \nInfant Cue when State is Bottle Offered")

with(dyad_set_table[dyad_set_table$dyad_set == "2moB",], prop.table(table(Behavior, next_group_narrow),1)) %>%
  kable(caption = "2 Month - Proportion of Behaviors for each \nInfant Cue when State is Bottle Offered")

with(dyad_set_table[dyad_set_table$dyad_set == "4moB",], prop.table(table(Behavior, next_group_narrow),1)) %>%
  kable(caption = "4 Month - Proportion of Behaviors for each \nInfant Cue when State is Bottle Offered")

with(dyad_set_table[dyad_set_table$dyad_set == "6moB",], prop.table(table(Behavior, next_group_narrow),1)) %>%
