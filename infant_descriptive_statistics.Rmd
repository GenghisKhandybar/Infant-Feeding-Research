...
data_dyad_total_zeros %>%
  ...
  ggtitle("Potent behhavior frequencies (excluding 0's)") + 
...
data_dyad_total_zeros %>%
  ...
  ggplot(aes(y=Behavior, x=(num_per_min), col=dyad_set)) +
  geom_boxplot(outlier.alpha = 0.25, outlier.size = 1) +
  ggtitle("Subtle behhavior frequencies (excluding 0's)") + 
  xlab("Cues per minute (log base 2 scale)")
...
data_dyad_total_zeros %>%
  ...
  ggplot(aes(y=Behavior, x=log2(num_per_min), col=dyad_set)) +
  geom_boxplot(outlier.alpha = 0.25, outlier.size = 1) +
  ggtitle("Subtle behhavior frequencies (excluding 0's, log scale)") + 
  xlab("Cues per minute (log base 2 scale)")
```
